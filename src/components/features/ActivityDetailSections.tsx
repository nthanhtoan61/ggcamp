...
export default function ActivityDetailSections({
  ...
  mainDescription = ["Eco-friendly glamping is reshaping how we connect with the outdoors—pairing the beauty of nature with sustainable comfort. From solar-powered tents and eco-conscious amenities to locally sourced cuisine and minimal-impact designs, every detail is crafted to protect the environment while enhancing your stay."],
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 max-w-5xl mx-auto">
          {introText.map((text, index) => (
            <div
              key={index}
              className="text-[1vw] text-gray-600 text-base leading-relaxed mb-6"
            >
              {text}
            </div>
          ))}
        ...
        >
          <div className="flex  ">
            ...
            <div className="text-[1vw] text-gray-900 leading-relaxed font-medium">
              {quote}
            </div>
          </div>
        </div>
        ...
        <div className="mb-12 max-w-5xl mx-auto">
          {outroText.map((text, index) => (
            <div
              key={index}
              className="text-[1vw] text-gray-600 text-base leading-relaxed mb-4"
            >
              {text}
            </div>
          ))}
        ...
        {/* Main Heading */}
        <div className="mb-8 max-w-5xl mx-auto">
          <div className="text-[1.7vw] font-bold text-gray-900 mb-4">
            {mainHeading}
          </div>
