      ...
      <div className="w-full px-[5vw] md:px-[3vw] relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-[5vw] items-start py-8 md:py-[5vh]">
          ...
          <div className="space-y-2 md:space-y-0">
            <p className="inline-flex items-center gap-2 md:gap-[0.5vw] !text-primary !font-bold tracking-widest uppercase text-lg md:text-[1vw] mb-2 md:mb-0 leading-none">
              - Why Choose Us
            </p>
          ...
          <div className="flex flex-col items-start">
            <p className="text-gray-600 text-lg md:text-[1vw] leading-relaxed mb-4 md:mb-[3vh]">
            ...
            <Link href="/booking">
              <button
                className="relative overflow-hidden rounded-full px-6 md:px-[2vw] py-3 md:py-[1.5vh] font-bold bg-[var(--color-primary)] hover:bg-[#b8b76a] text-white hover:text-black text-base md:text-[1vw] mt-4 md:mt-[2vh] transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl hover:-translate-y-1"
                onMouseEnter={(e) => {
        ...
        <div className="mt-8 md:mt-[5vh] grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-[3vw] mb-8 md:mb-[5vh]">
          {/* Card 1 */}
          <div className="relative overflow-hidden bg-white rounded-2xl md:rounded-[2vw] p-6 md:p-[2vw] shadow-lg hover:shadow-xl transition-all duration-300 group before:absolute before:bottom-0 before:left-0 before:right-0 before:bg-[var(--color-primary)] before:h-0 hover:before:h-full before:transition-all before:duration-500 min-h-[400px] md:min-h-[45vh]">
            <div className="relative z-10 w-16 h-16 md:w-[3vw] md:h-[3vw] !bg-[var(--color-primary)] group-hover:!bg-black rounded-full mx-auto mb-4 md:mb-[3.5vh] mt-4 md:mt-[2.5vh] flex items-center justify-center shadow-md transition-colors duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <div className="relative z-10 font-bold text-gray-900 group-hover:text-gray-950 text-xl md:text-[1.3vw] mb-2 md:mb-[1vh] text-center transition-colors duration-300">
              Inclusive & Welcoming
            </div>
            <div className="relative z-10 text-gray-600 group-hover:text-gray-800 text-lg md:text-[1vw] group-hover:!text-black leading-relaxed text-center transition-colors duration-300">
