    ...
    <div className="relative py-12 md:!py-[15vh]">
      ...
      <div className="relative z-10 w-full px-6 md:!px-[10vw]">
        <div className="text-center mb-8 md:!mb-[10vh]">
          <p className="flex items-center justify-center  gap-2 md:!gap-[0.5vw] !text-[var(--color-primary)] !text-[1vw] md:!text-[1.7vw] !font-bold mb-5 md:!mb-[4vh] tracking-wider">
            <img
              src="https://demo.awaikenthemes.com/wildex/wp-content/themes/wildex/assets/images/icon-sub-heading.svg"
              alt="icon"
              className="w-4 h-4 md:!w-[2vw] md:!h-[2vw]  object-contain flex-shrink-0"
            />
            OUR PARTNERS
          </p>
          <h2 className="!text-white !text-[3vw] md:!text-[2.7vw] !font-bold !leading-tight mx-auto px-4 whitespace-nowrap">
            ...
            {[1, 2, 3, 4, 2].map((num, idx) => (
              ...
              >
                <Image
                  ...
                  className="h-[8vw] md:!h-[6vh] w-[10vw] md:!w-[10vw] object-contain"
                />
              </div>
            ))}
          </div>
            ...
            {[2, 3, 4, 2].map((num, idx) => (
              ...
              >
                <Image
                  ...
                  className="h-[8vw] md:!h-[5vh] w-[10vw] md:!w-[10vw] object-contain"
                />
              </div>
            ))}
          </div>
        ...
        <div className="text-center">
          <div className="inline-flex flex-nowrap items-center justify-center px-4 md:!px-[1vw] py-2 md:!py-[1.5vh] rounded-full transition-colors cursor-pointer">
            ...
            <span className="!text-white font-semibold !text-[1vw] md:!text-[1.2vw] whitespace-nowrap">
              Let's make something great work together.
            </span>
            <Link
              href="/booking"
              className="!text-[var(--color-primary)] font-bold underline hover:no-underline !text-[0.5vw] md:!text-[1.2vw] whitespace-nowrap"
            >
              Get Free Quote
            </Link>
          </div>
