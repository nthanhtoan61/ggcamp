          ...
          <div className="uk-grid tm-grid-expand uk-grid-large uk-grid-margin-large" uk-grid="">
            ...
            <div className="uk-grid-item-match uk-width-1-3@m footer-social">
              <div className="uk-panel uk-width-1-1">
                ...
                <p className="!text-white mt-5">
                  ...
                  <a href="https://share.google/8G4LFRq82OwOmlFlN" target="_blank" rel="noopener" className="text-white no-underline !text-[0.79vw]">Check on google map</a>
                </p>
              </div>
            </div>
            {/* Column 2: Explore */}
            <div className="uk-grid-item-match uk-width-1-3@m footer-social">
              <div className="uk-panel uk-width-1-1 pl-20">
                ...
                <ul className="uk-list !text-white mt-5 leading-loose">
                  <li><Link href="/" className="text-white no-underline !text-[0.79vw]">Home</Link></li>
                  <li><Link href="/destinations" className="text-white no-underline !text-[0.79vw]">Activities</Link></li>
                  <li><Link href="/camp-profiles" className="text-white no-underline !text-[0.79vw]">Camp Locations</Link></li>
                  <li><Link href="/info" className="text-white no-underline !text-[0.79vw]">About Camp</Link></li>
                  <li><Link href="/info/contact" className="text-white no-underline !text-[0.79vw]">Contact</Link></li>
                </ul>
              </div>
            </div>
            {/* Column 3: Contact */}
            <div className="uk-grid-item-match uk-width-1-3@m">
              <div className="uk-panel uk-width-1-1">
                ...
                <div className="footer-social !text-white mt-5 leading-[1.8] !text-[0.79vw]">
                  <p><a href="https://share.google/8G4LFRq82OwOmlFlN" target="_blank" rel="noopener" className="!text-white no-underline !text-[0.79vw]">Poblacion, Madridejos 22,<br />Cebu City, Philippines</a></p>
                  <p className="text-[22px] mt-4 flex items-center !text-white !text-[0.79vw]">
                  ...
                  <div className="mt-5">
                    <ul className="uk-child-width-auto uk-grid-small uk-flex-inline uk-flex-middle footer-social" uk-grid="">
                      <li><a href="https://www.facebook.com/campadventuregermany/" aria-label="Facebook" target="_blank" rel="noreferrer" className="text-white !text-[0.79vw]"><span uk-icon="icon: facebook; width: 24; height: 24;"></span></a></li>
                      <li><a href="#" aria-label="Twitter" target="_blank" rel="noreferrer" className="text-white !text-[0.79vw]"><span uk-icon="icon: twitter; width: 24; height: 24;"></span></a></li>
                      <li><a href="https://www.instagram.com/campadventuregermany/" aria-label="Instagram" target="_blank" rel="noreferrer" className="text-white !text-[0.79vw]"><span uk-icon="icon: instagram; width: 24; height: 24;"></span></a></li>
                      <li><a href="#" aria-label="Behance" target="_blank" rel="noreferrer" className="text-white !text-[0.79vw]"><span uk-icon="icon: behance; width: 24; height: 24;"></span></a></li>
                      <li><a href="#" aria-label="LinkedIn" target="_blank" rel="noreferrer" className="text-white !text-[0.79vw]"><span uk-icon="icon: linkedin; width: 24; height: 24;"></span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
