      ...
      <div className="relative w-full h-screen hero-section">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <p className="!text-[1.667vw] !text-white mt-4 max-w-2xl drop-shadow-md opacity-0 animate-fadeUp animate-delay-200 hero-paragraph">
            Immerse yourself in a realm filled with excitement, discovery, and
            memorable experiences. Venture into nature, engage in thrilling
            activities, and forge lasting memories that you will cherish
            forever.
          </p>
