...
export default function EnglischToeflPage() {
  return (
    <>
      {/* Hero Section */}
      <div
          ...
          <div className="uk-container uk-container-large uk-position-relative">
            <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
              <div className="uk-width-1-1@m">
                ...
                >
                  <p>
                    Prepare for the TOEFL® test and get an internationally
      ...
      <div className="uk-section-muted uk-section">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <h2 className="uk-h2 uk-text-center">English TOEFL® Courses</h2>
              <div className="uk-divider-icon uk-width-medium uk-margin-auto"></div>
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                <p>
                  Apart from our Classic Courses, we also offer two-week TOEFL®
                  Courses. The Test Of English as a Foreign Language is the most
                  widely respected English language test in the world.
                </p>
                <p>
              ...
              >
                <div>
                  <div className="uk-card uk-card-default uk-card-body">
                    ...
                    <p>
                      TOEFL® courses in Lüneburger Heide and Bayerischer Wald.
                    </p>
                    <Link
            ...
            <div className="uk-width-1-1@m">
              ...
              <div className="uk-panel uk-margin">
                <div style={{ textAlign: "center" }}>
                  <iframe
                    src="https://www.bookacamp.de/en/booking/form/view-by-camp/ds7fdn347dsfndsf74n37en37en37dnd/regtoefl"
