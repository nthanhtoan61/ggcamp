    ...
    <>
      ...
      <div className="uk-section-muted uk-section">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <h2 className="uk-h2 uk-text-center">Spanish Course</h2>
              <div className="uk-divider-icon uk-width-medium uk-margin-auto"></div>
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                <p>
                  Our intensive Spanish course offers comprehensive language
                  instruction in the mornings, combined with exciting activities
                  in the afternoons. Learn Spanish from native speakers in small
                  classes designed for effective learning.
                </p>
                <p>
                  Perfect for students who want to improve their Spanish skills
                  while enjoying all the fun activities our Barcelona Beach Camp
                  has to offer.
                </p>
              </div>
            </div>
          ...
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <div className="uk-card uk-card-default uk-card-body">
                ...
                <p>
                  Spanish course at BISC Sailing Center in Barcelona with native
                  Spanish speakers.
                </p>
                <Link
