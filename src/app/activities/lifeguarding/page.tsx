...
export default function LifeguardingPage() {
  return (
    <>
      {/* Hero Section */}
      <div
            ...
            <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
              <div className="uk-width-1-1@m">
                <h1
                  ...
                  uk-scrollspy-class=""
                >
                  <p>Lifeguarding Course in Germany</p>
                </h1>
                <div
                ...
                >
                  <p>
                    Get certified as a lifeguard and learn essential water
                    safety skills!
                  </p>
                </div>
              </div>
      ...
      <div className="uk-section-muted uk-section">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <h2 className="uk-h2 uk-text-center">Lifeguarding Course</h2>
              ...
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                ...
                <p>
                  ...
                  practical training in our swimming facilities, preparing you
                  for real-world water safety situations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="uk-width-1-1@m">
              ...
              <div className="uk-panel uk-margin">
                <div style={{ textAlign: "center" }}>
                  <iframe
                    src="https://www.bookacamp.de/en/booking/form/view-by-camp/ds7fdn347dsfndsf74n37en37en37dnd/lifeguardingwal"
