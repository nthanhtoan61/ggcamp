...
export default function SeniorPlusLeadershipPage() {
  return (
    <>
      {/* Hero Section */}
      <div
            ...
            <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
              <div className="uk-width-1-1@m">
                <h1
                  ...
                  uk-scrollspy-class=""
                >
                  <p>Senior Plus & Leadership Program in Germany</p>
                </h1>
                <div
                ...
                >
                  <p>
                    For teenagers who want to take on more responsibility and
      ...
      <div className="uk-section-muted uk-section">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <h2 className="uk-h2 uk-text-center">Senior Plus & Leadership</h2>
              <div className="uk-divider-icon uk-width-medium uk-margin-auto"></div>
              <div className="uk-panel uk-dropcap uk-column-1-2@m uk-column-1-1@s uk-margin">
                <p>
                  Our Senior Plus & Leadership program is designed for teenagers
                  aged 15-17 who want to take on more responsibility and develop
                  leadership skills. This program offers unique opportunities to
                  mentor younger campers, assist with activities, and gain
                  valuable experience in leadership roles.
                </p>
                <p>
                  Participants will learn team management, communication skills,
                  and problem-solving while enjoying all the fun activities our
                  camps have to offer.
                </p>
              </div>
            </div>
          ...
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-width-1-1@m">
              <div className="uk-card uk-card-default uk-card-body">
                ...
                <p>
                  Our Senior Plus & Leadership program in Lüneburger Heide
          ...
          >
            <div className="uk-width-1-1@m">
              ...
              <div className="uk-panel uk-margin">
                ...
                >
                  <iframe
                    src="https://www.bookacamp.de/en/booking/form/view-by-camp/ds7fdn347dsfndsf74n37en37en37dnd/leadershipwal"
          ...
          <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
            <div className="uk-grid-item-match uk-width-1-1">
              <div className="uk-card-default uk-card uk-card-body">
                ...
                >
                  <p>
                    Outstanding Leadership Program! Our teenager developed
                    valuable leadership skills, gained confidence, and learned
                    to work effectively in teams. The program challenged them in
                    the best way and prepared them for future opportunities. An
                    incredible personal growth experience!
                  </p>
