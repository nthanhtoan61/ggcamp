...
<div className="flex flex-col w-full border border-[#e8e8e8] rounded-[20px] overflow-hidden">
  ...
  {/* Sidebar content */}
  <div
    className="uk-panel p-6 uk-background-muted w-full"
    style={{
      backgroundColor: "var(--color-background)",
      color: "#808080",
    }}
    ...
    <ul className="uk-nav uk-nav-default">
      {data.sidebar.menuItems.map((item: any, index: number, array: any) => (
        <li
          ...
          style={{
            borderBottom:
              index < array.length - 1 ? "1px solid #e5e5e5" : "none",
            paddingBottom: "12px",
          }}
        >
          <button
          ...
          >
            <div
              className="nav-text text-[2vw] md:text-[1vw] text-gray-600"
            ...
            <div className="w-4 h-4 flex items-center justify-center flex-shrink-0">
              <svg
                ...
                style={{
                  ...
                  transition:
                    "transform 0.4s cubic-bezier(0.2, 0.8, 0.2, 1), fill 0.3s ease",
                }}
              >
  ...
  <div className="p-5 bg-white">
    <a href={`/booking`} className="block w-full">
      <div className="uk-button uk-button-default w-full">Booking</div>
    </a>
  </div>
</div>
              ...
              >
                ...
                <div style={{ marginBottom: "30px" }}>
                  ...
                  <div 
                  className=" text-[3.36vw] md:text-[1.7vw] font-semibold leading-[1.4] mt-5"
                  >
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                  <li style={{ marginBottom: "15px" }}>
                    <a
                      href={`tel:${data.sidebar.contact.phone}`}
                      style={{
                        display: "flex",
                        alignItems: "center",
                        gap: "12px",
                    ...
                    >
                      <svg 
                        className="w-[3vw] h-[3vw] md:w-[1.5vw] md:h-[1.5vw]"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                      >
                      ...
                      <div className=" text-[2vw] md:text-[1vw]">{data.sidebar.contact.phone}</div>
                    </a>
                  </li>
                  <li>
                    <a
                      href={`mailto:${data.sidebar.contact.email}`}
                      style={{
                        display: "flex",
                        alignItems: "center",
                        gap: "12px",
                    ...
                    >
                      ...
                      <div className=" text-[2vw] md:text-[1vw]">{data.sidebar.contact.email}</div>
                    </a>
                  </li>
                </ul>
              </div>
              ...
              {/* Upcoming Tours */}
              <div className="mx-auto w-full p-6 bg-background rounded-lg">
                <div className="text-[3.63vw] md:text-[1.7vw] font-bold text-gray-900 mb-6">
                  Upcoming Tour
                </div>
                    ...
                    >
                      <div className="flex gap-4 p-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-[3vw] md:text-[1.5vw] font-semibold text-gray-900 mb-1">
                            {tour.title}
                          </div>
                          <div className="flex items-center gap-1 mb-2">
                            <Star className="w-4 h-4 fill-gray-900 text-gray-900" />
                            <div className="font-semibold text-gray-900 text-[2vw] md:text-[1vw]">
                              {tour.rating}
                            </div>
                            <div className="text-[2vw] md:text-[1vw] text-gray-500">
                              ({tour.reviews} reviews)
                            </div>
                          </div>
                          <div className="flex items-center gap-1 mb-3">
                            <MapPin className="w-4 h-4 text-gray-600" />
                            <div className="text-[2vw] md:text-[1vw] text-gray-600">
                              {tour.location}
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                            <div className="text-[3vw] md:text-[1.5vw] font-bold text-gray-900">
                              ${tour.price}
                            </div>
                            <div className="text-[2vw] md:text-[1vw] text-red-500 line-through">
                              ${tour.originalPrice}
                            </div>
                          </div>
                        </div>
            ...
            <div className="flex flex-col gap-8 w-full">
              ...
              <div className="w-full mt-5">
                <div className=" text-[3.63vw] md:text-[1.7vw] font-semibold text-gray-900 mb-6">
                  Event Schedule
                </div>
                <div className="border-t border-b border-gray-200 py-6">
                  <div className="flex flex-col flex-row items-start items-center justify-between gap-8">
                    <div className="flex items-start gap-3">
                      <Clock className="w-5 h-5 text-gray-700 mt-1" />
                      <div>
                        <div className="text-[3vw] md:text-[1.5vw] font-semibold mb-1">
                          Start Date
                        </div>
                        <div className="text-[2vw] md:text-[1vw] font-medium">
                          {data.eventSchedule.startDate}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <Moon className="w-5 h-5 text-gray-700 mt-1" />
                      <div>
                        <div className="text-[3vw] md:text-[1.5vw] font-semibold mb-1">
                          Duration
                        </div>
                        <div className="text-[2vw] md:text-[1vw] font-medium">
                          {data.eventSchedule.duration}
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <Ticket className="w-5 h-5 text-gray-700 mt-1" />
                      <div>
                        <div className="text-[3vw] md:text-[1.5vw] font-semibold mb-1">
                          Total Ticket
                        </div>
                        <div className="text-[2vw] md:text-[1vw] font-medium">
                          {data.eventSchedule.tickets}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
                  <div>
                    ...
                    >
                      ...
                      >
                        {data.sections.overview.featuresTitle}
                      </div>
                    </div>
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                      {data.sections.overview.features.map(
                        (feature: string, idx: number) => (
                          ...
                          >
                            ...
                            <div className="text-base md:text-[1vw]">
                              {feature}
                            </div>
                          </li>
                        )
                  ...
                  <div className="relative z-10 rounded-2xl overflow-hidden group cursor-pointer h-[300px] md:h-auto">
                    <img
                      src={data.sections.overview.featureImage}
                      alt="Feature"
                      style={{
                        width: "100%",
                        height: "100%",
              ...
              >
                ...
                >
                  {data.sections.location.description}
                </div>
                <div className="flex flex-col md:flex-row gap-8 h-auto md:h-[400px]">
                  {data.sections.location.images.map(
                    (img: string, idx: number) => (
                      <div
                        key={idx}
                        className={`relative z-10 rounded-2xl overflow-hidden group cursor-pointer w-full ${
                          idx === 0 ? "md:flex-[7]" : "md:flex-[3]"
                        } h-[250px] md:h-full`}
              ...
              <ActivityDetailSections
                id="accommodation"
                heroImage={{
                  src: data.sections.accommodation.heroImage,
              ...
              <ActivityDetailSections
                id="program"
                heroImage={{
                  src: data.sections.program.heroImage,
                  alt: "program img",
                }}
              ...
              >
                ...
                >
                  {data.sections.meals.description}
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {data.sections.meals.items.map((item: any, idx: number) => (
                    ...
                    >
                      ...
                      <div
                        className="text-base md:text-[1vw]"
                        style={{ lineHeight: "1.7", color: "#666", margin: 0 }}
                      >
                        {item.desc}
                      </div>
                    </div>
                ...
                <div
                  className="text-base md:text-[1vw]"
                  style={{ lineHeight: "1.8", color: "#666", margin: "40px 0" }}
                >
                  {data.sections.meals.footer}
                </div>
              </div>
              ...
              <ActivityDetailSections
                id="team"
                heroImage={{
                  src: data.sections.team.heroImage,
                  alt: "team img",
                }}
              ...
              >
                ...
                >
                  {data.sections.insurance.description}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  >
                    ...
                    >
                      {data.sections.insurance.package.title}
                    </div>
                    <div
                      className="text-base md:text-[1vw]"
                      style={{
                    ...
                    >
                      {data.sections.insurance.package.desc}
                    </div>
                    <hr />
                    <ul
                      style={{
                    ...
                    >
                      {data.sections.insurance.package.items.map(
                        (item: string, idx: number) => (
                          ...
                          >
                            ...
                            <div className="text-sm md:text-[0.86vw]">
                              {item}
                            </div>
                          </li>
                        )
                  ...
                  >
                    ...
                    >
                      {data.sections.insurance.cancellation.title}
                    </div>
                    <div
                      className="text-base md:text-[1vw]"
                      style={{
                    ...
                    >
                      {data.sections.insurance.cancellation.desc}
                    </div>
                    <hr />
                    <ul
                      style={{
                    ...
                    >
                      {data.sections.insurance.cancellation.items.map(
                        (item: string, idx: number) => (
                          <li
                            key={idx}
                            style={{
