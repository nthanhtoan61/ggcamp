...
useEffect(() => {
  ...
  style.textContent = `
    ...
    /* ANIMATION HOVER CHO MŨI TÊN NAVIGATION - TỪ CODE MỚI */
    ...
    .group:hover .sidebar-arrow {
      transform: translateX(3px) translateY(-3px) !important; /* Di chuyển mũi tên khi hover */
      ...
      <div className="uk-section-default uk-section bg-[#f7f7f7]!">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-grid-margin" uk-grid="">
            {/* Sidebar */}
            <div className="faq-sidebar uk-width-2-5@m w-full  md:text-[12vw]!"  
              style={{
                height: "fit-content"
              }}
            >
              {/* Navigation Box */}
              <div className="uk-panel uk-padding uk-background-muted uk-border-rounded mb-5"      
                   style={{backgroundColor: '#ffffff', borderRadius: '15px', color: '#808080'}}>
                <ul className="uk-nav uk-nav-default md:text-[12vw]!">
                  {[
                    ...
                    <li
                      key={item.id}
                      className="uk-margin-small-bottom group  md:text-[12vw]!"
                      style={{
                    ...
                    >
                      <button
                        ...
                        className="w-full flex justify-between items-center text-left text-[#808080] font-normal bg-transparent border-none cursor-pointer px-0 py-2 text-[4.2vw] md:text-[1.3vw] transition-colors duration-300">
              ...
              {/* Contact Box */}
              {/* Contact Box */}
<div className="contact-box rounded-lg bg-[var(--color-primary)] text-center p-15" style={{height:"auto"}}>
  {/* Icon lớn đầu tiên */}
  <svg xmlns="http://www.w3.org/2000/svg" className="w-[10vw] md:w-[5vw]" viewBox="0 0 50 50" fill="currentColor">
  ...
  <h2 className="md:text-2xl! contact-title text-[#292c3d] uk-text-left@m uk-text-left" style={{color:"black"}}>
    <strong>Let&apos;s plan your perfect nature escape</strong>
  </h2>
  
  <div className="flex items-center justify-left gap-3 mt-4  md:text-[2vw]" style={{color:"white"}}>
  ...
  <div className="flex items-center justify-left gap-3 mt-4 md:text-[2vw]" style={{color:"white"}}>
    ...
    <p className="contact-text text-black! font-bold whitespace-nowrap m-0! font-[Raleway]" >
      hello@ggcamp.org
            ...
            {/* FAQ Content - Right */}
            <div className="faq-content uk-width-3-5@m w-full md:pl-15!">
