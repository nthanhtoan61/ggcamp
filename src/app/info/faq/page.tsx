        ...
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-grid-margin" uk-grid="">
            ...
            >
                  ...
                  {[
                    ...
                    >
                      <button
                        ...
                        className="w-full flex justify-between items-center text-left text-[#808080] font-normal bg-transparent border-none cursor-pointer px-0 py-2 text-[3.5vw] md:text-[1.5vw] transition-colors duration-300">
              ...
              {/* Contact Box */}
              <div className="contact-box rounded-lg bg-[var(--color-primary)] text-center p-12" style={{height:"auto"}}>
                {/* Big Icon */}
