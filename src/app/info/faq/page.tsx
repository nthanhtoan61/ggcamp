...
export default function FAQPage() {
  ...
  return (
    <>
      ...
      <div className="uk-section-default uk-section bg-[#f7f7f7]!">
        <div className="uk-container uk-container-large">
          <div className="uk-grid tm-grid-expand uk-grid-margin" uk-grid="">
            {/* Sidebar */}
            <div className="w-full uk-width-2-5@m lg:sticky lg:top-5 lg:self-start lg:h-fit static top-0 self-stretch h-auto max-lg:w-full max-lg:mb-5 lg:-ml-[10px]"  
              style={{ height: "fit-content", alignSelf: "flex-start" }}
            >
              {/* Navigation Box */}
              <div className="uk-panel md:w-auto! uk-padding uk-background-muted uk-border-rounded mb-5 mr-0 md:mr-[50px]!"      
                  ...
                  {faqCategories.map((category, index, array) => (
                    ...
                    >
                      <button
                        ...
                        className="md:text-[1.2vw]! uk-button uk-button-link uk-text-left uk-padding-remove-left uk-width-1-1 text-[1.1rem] uk-text-normal"
                        style={{
                          textDecoration: 'none',
                          display: 'flex',
              ...
              {/* Contact Box */}
              <div className="lg:w-[xl] md:w-auto! mt-8 rounded-lg w-full max-lg:w-full lg:sticky lg:top-[120px] static top-0 bg-[var(--color-primary)] text-center mr-0 md:mr-[50px]" style={{padding:"40px", height:"auto"}}>
                ...
                <h2 className="text-xl! sm:text-[3.5vw]! md:text-[2vw]! text-[#292c3d] uk-text-left@m uk-text-left" style={{color:"black"}}>
                ...
                <div className="flex items-center justify-left gap-3 mt-4" style={{color:"white"}}>
                  ...
                  <p className="sm:text-2xl md:text-[2vw]! lg:text-[2vw]! xl:text-[1.5vw]! 2xl:text-[1vw]! text-black! font-bold whitespace-nowrap m-0! font-[Raleway]" >
                    +(123)-456-789
                  </p>
                </div>
  ...
  {/* Icon Email */}
  <svg 
    className="w-6 h-6 flex-shrink-0 text-[#292c3d]" 
    viewBox="0 0 30 30" 
    fill="currentColor"
  >
  ...
  <span className="text-[#292c3d] font-medium">hello@ggcamp.org</span>
</div>
              </div>
            </div>
            
            {/* FAQ Content - Right */}
            <div className="uk-width-3-5@m sm:w-full pl-5!">
              {/* Render tất cả FAQ categories */}
              {faqCategories.map((category) => (
                <div 
                  key={category.id} 
                  id={category.id} 
                  className="uk-section-default bg-[#f7f7f7]! pb-5 lg:pl-5 max-lg:pl-0 px-4 lg:px-0"
                >
                  <div className="uk-container uk-container-large">
                    <div className="uk-grid tm-grid-expand uk-child-width-1-1 uk-grid-margin">
                      <div className="uk-width-1-1@m">
                        <h2 className="text-2xl! md:text-[2.5vw]! text-[#292c3d] font-extrabold! text-center lg:text-left">
                        ...
                        <div className="custom-accordion" uk-accordion="collapsible: true;">
                          {category.cards.map((card, index) => (
                            <div 
                              key={index} 
                              className={`el-item uk-margin-bottom mb-5 bg-white rounded-lg shadow-md p-0 ${index === 0 ? 'uk-open' : ''}`}
                            >
                              <a 
                                href="#" 
                                className="flex! text-md! md:text-[1.5vw]! justify-between items-center p-4 rounded-lg bg-white! text-[#292c3d]! no-underline relative md:pl-10 pl-6 uk-accordion-title text-base md:text-lg"
                              >
                              ...
                              <div className="uk-accordion-content" style={{display:"flow-root", marginTop:"0.1px"}}>
                                <div className="text-base sm:text-[xl] md:text-[xl]! uk-panel rounded-b-lg bg-[var(--color-primary)] md:px-10 md:py-4 px-6 py-3">
                        ...
                        {/* Thêm video chỉ cho section "camp-routine" */}
                        {category.id === 'camp-routine' && (
