        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-[4vw]">
          <div className="relative w-full h-full">
            ...
            <div className="flex items-start justify-between gap-5 md:gap-[1vw]">
              {/* Ảnh to bên trái */}
              <div
                className="w-2/3 md:w-[32vw] md:h-[70vh] relative z-10 rounded-2xl overflow-hidden group cursor-pointer"
            ...
            <div
              className="md:absolute md:w-[70%] md:h-[50%] z-20 rounded-2xl overflow-hidden md:border-[6px] md:ml-[13vw] mt-3 md:-mt-[35vh] border-white md:translate-y-8 group cursor-pointer"
          ...
          >
            ...
            {/* Description */}
            <p
              className="text-gray-500 leading-relaxed md:text-[1vw] animate-fadeUp "
              uk-scrollspy-class="uk-animation-slide-bottom-medium"
            >
            ...
            {/* Features List */}
            <div
              className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-4 animate-fadeUp "
              uk-scrollspy-class="uk-animation-slide-bottom-medium"
            >
              {[
            ...
            >
              {/* Card 1: Vision */}
              <div
                className="bg-white p-6 rounded-2xl shadow-sm flex-1"
                uk-scrollspy-class="uk-animation-slide-bottom-medium"
              >
            ...
            <div className="uk-width-1-1@m">
              ...
              <div className="uk-margin uk-text-left@m uk-text-center">
                <div
                  ...
                  uk-grid=""
                >
                  {pageData.philosophyCards.map((card, idx) => (
                    <div key={idx}>
                      {/* --- BẮT ĐẦU CARD --- */}
                      <div
                        className="el-item uk-card uk-card-default uk-card-body flex! flex-col! h-full!"
                        uk-scrollspy-class="uk-animation-slide-bottom-medium"
                      >
                        {/* Header: Quote & Stars */}
                        ...
                        {/* Title */}
                        <div className="text-center font-['Raleway'] text-lg md:text-[1.5vw] text-black leading-tight font-semibold">
                          {card.title}
                        </div>

                        {/* Content / Description */}
                        <div className="el-content uk-panel uk-margin-top">
                          <p className="font-['Raleway'] text-xs md:text-[1vw] leading-relaxed mb-3! md:mb-[3vh]!">
                            {card.description}
                          </p>
                        </div>
            ...
            <div className="uk-width-1-1@m">
              <div className="uk-margin uk-text-left@m uk-text-center">
                <div
                  ...
                  uk-grid=""
                >
                  {pageData.securityCards.map((card, idx) => (
                    <div key={idx}>
                      <div
                        className="el-item uk-card uk-card-default uk-card-body flex! flex-col! h-full!"
                        uk-scrollspy-class="uk-animation-slide-bottom-medium"
                      >
                        ...
                        <div className="text-center font-['Raleway'] text-[2vw] md:text-[1.5vw] text-black leading-tight font-semibold max-[991px]:text-[5vw]">
                          {card.title}
                        </div>
                        <div className="flex flex-col gap-[2vh] justify-between"></div>
                        <div className="el-content uk-panel uk-margin-top">
                          <p className="font-['Raleway'] text-xs md:text-[1vw] leading-relaxed mb-3! md:mb-[3vh]!">
                            {card.description}
                          </p>
